    ...
    return (
      ...
      >
        ...
        <CardContent className="space-y-4">
          {/* Sale Type Display - Auto-calculated */}
          <div className="space-y-2">
            <FormLabel>Sale Type (Auto-calculated)</FormLabel>
            <div className="px-3 py-2 bg-muted rounded-md text-sm">
              <span className="font-medium">
                {(() => {
                  ...
                  switch (saleType) {
                    case "cash":
                      return "💰 Cash Sale - Fully Paid";
                    case "credit":
                      return "📋 Credit Sale - No Payment";
                    case "partial":
                      return "⚖️ Partial Payment - Partial Payment";
                    default:
                      return "💰 Cash Sale";
                  }
                })()}
          ...
          {/* Payment Fields - Always Available */}
          ...
          {paymentFields.map((payment, index) => (
            <div key={payment.id} className="flex flex-col gap-2 mb-2">
              <FormField
                control={form.control}
                name={`saleWithPayment.payments.${index}.paymentDate`}
                render={({ field }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name={`saleWithPayment.payments.${index}.amountPaid`}
                render={({ field }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name={`saleWithPayment.payments.${index}.paymentMethod`}
                render={({ field }) => (
                  <FormItem>
          ...
          {/* Add Payment Button - Always Available */}
          <Button
            type="button"
            variant="outline"
          ...
          <div className="pt-4 space-y-2">
            <div className="flex justify-between font-semibold">
              ...
              <span>
                PKR{" "}
                {(() => {
                  const payments = form.watch("saleWithPayment.payments") || [];
